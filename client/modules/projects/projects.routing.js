System.register(['@angular/router', './index/index.component', './project-wizard/project-wizard.component', './projects.component', '../../service/auth.service'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, index_component_1, project_wizard_component_1, projects_component_1, auth_service_1;
    var routes, routing;
    return {
        setters:[
            function (router_1_1) {
