System.register(['@angular/core', '@angular/platform-browser', "@angular/http", './app.component', "./routes", "./components/shared/hello.component", "./modules/projects/projects.module", "./modules/auth/auth.module", "./modules/home/home.module", '@angular2-material/card', '@angular2-material/button', '@angular2-material/toolbar', '@angular2-material/icon', '@angular2-material/sidenav', '@angular2-material/list', './service/microservices/ms-project-client.service', './service/microservices/ms-user-client.service', './service/auth.service'], function(exports_1, context_1) {
    ...
    var core_1, platform_browser_1, http_1, app_component_1, routes_1, hello_component_1, projects_module_1, auth_module_1, home_module_1, card_1, button_1, toolbar_1, icon_1, sidenav_1, list_1, ms_project_client_service_1, ms_user_client_service_1, auth_service_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
